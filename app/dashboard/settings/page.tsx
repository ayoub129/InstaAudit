        ...
        <TabsContent value="profile">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Button className="bg-pink-500 hover:bg-pink-600" onClick={handleSaveProfile}>
                Save Changes
              </Button>
            </CardContent>
          </Card>
        ...
        <TabsContent value="notifications">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Button className="bg-pink-500 hover:bg-pink-600" onClick={handleSaveNotifications}>
                Save Preferences
              </Button>
            </CardContent>
          </Card>
